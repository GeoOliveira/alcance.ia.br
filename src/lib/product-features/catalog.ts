...
export const productFeatureCatalog: readonly ProductFeatureDefinition[] = [
  ...
  { ...profile, key: "whatsapp_link_generator", name: "Gerador de Link WhatsApp Curto", description: "Gera localmente o link oficial wa.me para um número brasileiro e uma mensagem opcional.", group: "category", defaultAudience: "public", defaultStatus: "active", defaultVisibility: "full", defaultEnabled: true, defaultLimits: { maxItems: 1, dailyRequests: 0, cacheMinutes: 0 } },
