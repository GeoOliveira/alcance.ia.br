...
export default function Page() {
  return <LegalPageLayout title="Política de Privacidade" intro="Entenda quais dados podem ser tratados, para quais finalidades e como exercer seus direitos conforme a LGPD.">
    ...
    <h2>7. Inteligência artificial e dados de terceiros</h2><p>Recursos futuros de IA serão assistivos. O usuário deve ter legitimidade para fornecer dados de terceiros. Resultados poderão conter estimativas e não constituirão garantia de desempenho.</p>
