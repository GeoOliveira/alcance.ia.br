...
export default async function IntegrationsPage() {
  ...
  const google = await getGoogleAuthPublicConfig();
  const integrations = [
    { href: "/admin/integracoes/google", name: "Google", description: "Login com Google, Client ID, origens autorizadas, estado do provider e métodos de acesso.", permission: "settings.manage" as const, status: () => Boolean(google.clientId) },
